...
export const testMap: MapDefinition = {
  ...
  cities: [
    { id: 'b1', name: 'Arden',  x: sc(14), y: sc(14), baseProduction: 2, owner: 'blue', integration: 1 },
    { id: 'b2', name: 'Mirov',  x: sc(34), y: sc(36), baseProduction: 2, owner: 'blue', integration: 1 },
    ...
    { id: 'r4', name: 'Belgor', x: sc(80), y: sc(15), baseProduction: 1, owner: 'red', integration: 1 },
    { id: 'r5', name: 'Radin',  x: sc(84), y: sc(58), baseProduction: 2, owner: 'red', integration: 1 },
  ],
};
